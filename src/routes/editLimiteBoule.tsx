...
import { tirage } from "../components/statistique/selectData";
...
export function EditLimiteBoule() {
  ...
  const tirageOp = `${Tirage}`;
  return (
    <div className="px-8 py-8 flex-1 w-full flex-col">
      <div className="flex flex-col gap-4">
        <div>
          <span className="text-2xl font-bold">Modifier limite des boules</span>
        </div>
        <div>
          <Breadcrumbs>
